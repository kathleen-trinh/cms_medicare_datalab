CREATE TABLE cms_raw.outpatient_claims (
    ...
    nch_bene_ptb_ddctbl_amt FLOAT, -- NCH Beneficiary Part B Deductible Amount
    nch_bene_ptb_coinsrnc_amt FLOAT, -- NCH Beneficiary Part B Coinsurance Amount
